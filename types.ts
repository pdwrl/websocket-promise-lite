...
export interface IConfig {
  ...
  /** use it when second url part have to be generated by some algorythm. Pass a function. */
  ...
  /** function (async or not) which is called when a connection is opened successfully for a 1st time */
  onConnectionOpen?: () => Promise<void>

  /** function (async or not) which is called when a connection is closed.
  ...
  */
  ...
  /** function (async or not) which is called when a connection is before reopen.
  ...
  */
  ...
  /** function (async or not) which is called when a connection is opened successfully for a 2nd+ time */
  onConnectionReOpen?: () => Promise<void>

  /** function (async or not) which is called when server sends not promised data (simple WS data from back-end)
